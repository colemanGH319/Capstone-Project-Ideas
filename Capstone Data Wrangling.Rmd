...
* Going any further back in time may cause data to be of lesser quality and may also reflect a riskier loan portfolio prior to Lending Club's 2014 IPO.
...
```
  ...
  * mths_since_last_major_derog (`r define.var("mths_since_last_major_derog")`)
  * mths_since_recent_bc_dlq (`r define.var("mths_since_recent_bc_dlq")`)
  * mths_since_recent_inq (`r define.var("mths_since_recent_inq")`)
  * mths_since_recent_revol_delinq (`r define.var("mths_since_recent_revol_delinq")`)
  * num_tl_120dpd_2m (`r define.var("num_tl_120dpd_2m")`)
  * emp_length (`r define.var("emp_length")`) - Additional data manipulation will be done to this column later.
  ...
  * avg_cur_bal (`r define.var("avg_cur_bal")`)
  * bc_open_to_buy (`r define.var("bc_open_to_buy")`)
  * bc_util (`r define.var("bc_util")`)
  * mths_since_recent_bc (`r define.var("mths_since_recent_bc")`)
